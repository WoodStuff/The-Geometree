	...
	tabFormat: {
		'Lore': {
			content: [
				...
				['display-text', 'You\'ve decided that creating points is pretty fun, and now you\'re just trying to make a lot of points. There\'s a small possibility, but you could possibly unlock some new stuff for the 2D world.'],
